# # Colour, fonts and themes for the Hi-Knowledge visualisations
# library (sysfonts)
# library(ggplot2)
...
# font_add("Work Sans",
#          regular = "resources/Work_Sans/WorkSans-VariableFont_wght.ttf",
#          italic = "resources/Work_Sans/WorkSans-Italic-VariableFont_wght.ttf"
# )
          ...
          base_rect_size = base_size/22) 
{
  ...
  t <- theme(line = element_line(colour = "black", linewidth = base_line_size, 
             ...
             text = element_text(family = base_family, face = "plain", 
                                 colour = "#27596B", size = base_size, lineheight = 0.9, 
